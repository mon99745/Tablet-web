    ...
    <div id=tablet> 
        <div id=left-sidebar> <!--왼쪽 사이드 레이아웃--> 
            ...
            <div class=left-list> <!--=왼쪽 사이드 메뉴 리스트-->
                    <ul>
                        <li>
                            <button type="button" id=sidebar onclick="location.href='login.html'">
                              로그인
                            </button>    
                        <li>
                    	...
                    	<li>
							<button type="button" id="sidebar" onclick="location.href='chat.html'">
								채팅
							</button>
						</li>
						<li>
							<button type="button" id="sidebar" onclick="location.href='songRequest.html'">
								노래 신청
							</button>
						</li>
                        <li>
                            <button type="button" id="sidebar" onclick="location.href='roulette.html'">
								룰렛
							</button>
                            </li>
                        <li>
